...
header_row = ['age', 'sex', 'pain', 'BP', 'chol', 'fbs', 'ecg', 'maxhr', 'eiang', 'oldpeakst', 'slope', 'vessels', 'thal',
...
def train_classifier(x_train,x_test,y_train,y_test,string):                         # Declaring the function for training classifiers and classification analysis
    global clf                                                                      # Declaring clf as a Global Variable for using throughout the code
    global outclass
...
def process_dataset(string):
    ...
    if string=="Cleveland":
        ...
        ind1 = np.where((heart['diagnosis'] == 1)|(heart['diagnosis'] ==2)|(heart['diagnosis'] == 3)|(heart['diagnosis'] ==4));
        ...
        x_train, x_test, y_train, y_test = train_test_split(heart.loc[:, 'age':'thal'], heart.loc[:, 'diagnosis'],   # Splitting the processed data into training data and testing data
                                                        test_size=0.10, random_state=42)                            # test_size = percent of data used for testing,
        ...
        ind1 = np.where((heart_hu['diagnosis'] == 1)|(heart_hu['diagnosis'] ==2)|(heart_hu['diagnosis'] == 3)|(heart_hu['diagnosis'] ==4));
        ...
        ind1 = np.where((heart_cl['diagnosis'] == 1)|(heart_cl['diagnosis'] ==2)|(heart_cl['diagnosis'] == 3)|(heart_cl['diagnosis'] ==4));
        ...
        ind1 = np.where((heart_va['diagnosis'] == 1)|(heart_va['diagnosis'] ==2)|(heart_va['diagnosis'] == 3)|(heart_va['diagnosis'] ==4));
        #ind2 = np.where((heart_va['diagnosis'] == 3)|(heart_va['diagnosis'] ==4));
